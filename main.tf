...
module "nat-gateway" {
  source            = "github.com/GoogleCloudPlatform/terraform-google-managed-instance-group?ref=5455a58a38b4fd222e27d8c4045cb480dc38d88e"
  project           = "${var.project}"
  region            = "${var.region}"
  ...
  compute_image     = "projects/debian-cloud/global/images/family/debian-8"
  size              = 1
  network_ip        = "${var.ip}"
  can_ip_forward    = "true"
  service_port      = "80"
